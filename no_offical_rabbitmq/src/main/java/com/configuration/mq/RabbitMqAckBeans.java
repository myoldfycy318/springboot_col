...
import com.component.mq.listener.ack.MessageConsumer;
import com.component.mq.listener.ack.MessageConsumer2;
import com.component.mq.listener.ack.MsgSendConfirmCallBack;
import com.component.mq.listener.ack.MsgSendReturnCallback;
...
public class RabbitMqAckBeans {
    ...
    public Binding binding_one() {
        return BindingBuilder.bind(queue_one()).to(directExchange()).with(ROUTINGKEY1);
    }
    ...
    public Binding binding_two() {
        return BindingBuilder.bind(queue_two()).to(directExchange()).with(ROUTINGKEY2);
    }
     ...
     */
    @Bean
    public RabbitTemplate confirmCBRabbitTemplate() {
